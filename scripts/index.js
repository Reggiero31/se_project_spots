...
const newPostLink = newPostForm.querySelector("#card-link-input");
...
const modal = document.querySelectorAll(".madal");
...
function handleCardSubmit(evt) {
  evt.preventDefault();
  const values = { name: captionInput.value, link: linkInputEl.value };
